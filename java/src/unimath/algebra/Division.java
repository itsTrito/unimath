...
public class Division<T extends Number> extends AlgebraUnit<T> {
    private final AlgebraUnit<T> a;
    private final AlgebraUnit<T> b;

    public Division(AlgebraUnit<T> a, AlgebraUnit<T> b) {
        this.a = a;
        this.b = b;
    }
    ...
    public T computeValue() {
        return divide(a.computeValue(), b.computeValue());
    }
    ...
    private static <T extends Number>T divide(T a, T b) {
