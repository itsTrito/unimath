...
public class Multiplication<T extends Number> extends AlgebraUnit<T> {
    private final AlgebraUnit<T> a;
    private final AlgebraUnit<T> b;

    public Multiplication(AlgebraUnit<T> a, AlgebraUnit<T> b) {
        this.a = a;
        this.b = b;
    }
    ...
    public T computeValue() {
        return multiply(a.computeValue(), b.computeValue());
    }
